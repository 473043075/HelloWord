        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" name="borrrow"
                               title="查询图书" content="searchBooks.jsp" id="1">查询图书</a></dd>
                        <dd><a href="javascript:;" name="borrrow"
                               title="借阅历史" content="userHistory.jsp" id="2">借阅历史</a></dd>
                        <dd><a href="javascript:;" name="borrrow"
                               title="在借图书" content="borrowList.jsp" id="3">在借图书</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
