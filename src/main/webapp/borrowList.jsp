...
<div class="layui-form" id="content">
    <table class="layui-table" style="table-layout:fixed">
        ...
        <tbody>
        <c:forEach var="borrowLists" items="${sessionScope.borrowLists}"
                   varStatus="status">
            <tr>
                <td>${borrowLists.borrow_id}</td>
                <td>${borrowLists.name}</td>
                <td>${borrowLists.author}</td>
                <td>${borrowLists.sort}</td>
                <td class="wrap-td">
                    <div class="wrap-div">${borrowLists.description}</div>
                </td>
            </tr>
        </c:forEach>
        </tbody>
